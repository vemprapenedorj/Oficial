...
const AdvertiseBusinessPage = React.lazy(() => import('./pages/AdvertiseBusinessPage').then(module => ({ default: module.AdvertiseBusinessPage })));
    ...
    <div className="min-h-screen flex flex-col font-sans relative">
      ...
      <main className="flex-grow pt-0 overflow-x-hidden relative">
        <React.Suspense fallback={(
          ...
          <Route path="/divulgue-seu-negocio" element={(
              <PageTransition key="advertise-business">
                <SEO
                  title="Divulgue seu negócio em Penedo | Vem Pra Penedo"
                  description="Apresente seu hotel, restaurante, loja, passeio ou experiência para quem planeja visitar Penedo e a Serra da Mantiqueira."
          ...
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12">
            ...
            <div>
              ...
              <div className="flex gap-4 mb-4">
                ...
                <a href={getOfficialWhatsAppUrl()} target="_blank" rel="noopener noreferrer"
