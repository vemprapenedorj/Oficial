      ...
      >
        ...
        >
          <div className="relative h-64 sm:h-80 bg-gray-100 flex items-center justify-center overflow-hidden">
            ...
            {['pequena-finlandia', 'pequena-finlandia-shopping', 'lelu-museu', 'hotel-girassol', 'hotel-bertell', 'hotel-britannia', 'hotel-daniela', 'hotel-da-cachoeira', 'pousada-serra-da-india', 'hotel-rio-penedo', 'hotel-do-sino', 'hotel-titanic', 'pousada-aurora-mantiqueira', 'pousada-chez-nous', 'pousada-penedo', 'pousada-reserva-penedo', 'pousada-terraco', 'pousada-villa-luna', 'pousada-rainha-da-mata', 'vila-francesa-hotel', 'aglio-e-olio', 'bazzini-pizzeria', 'borbulha-penedo', 'botegare', 'braseiro-gaucho', 'casa-da-picanha', 'casa-do-fritz', 'enoteca-serrana', 'estancia-penedo', 'kaiten-sushi', 'loazo-resto', 'petit-gourmet', 'pizza-da-villa', 'querencia', 'rei-das-trutas', 'restaurante-finlandes', 'truta-viva', 'zero-a-zero', 'tonttulakki-suklaat', 'lugano-penedo', 'lolita-penedo', 'kahvila-cafe', 'chocolate-do-papai-noel', 'emporio-haru', 'pousada-recanto-de-moria', 'unica-arte-para-voce', 'azia-sushi-lounge', 'bistro-du-cheff', 'sorvete-de-penedo', 'sorvete-finlandes', 'acailandia-penedo', 'pe-de-canela-buteco', 'janela-divino'].includes(item.id) && (
              <div 
            ...
            <img 
              ...
              className={`relative z-10 w-full h-full ${
                item.id === 'enoteca-serrana'
                  ...
                  : ['pequena-finlandia', 'pequena-finlandia-shopping', 'lelu-museu', 'hotel-bertell', 'hotel-britannia', 'hotel-daniela', 'hotel-da-cachoeira', 'pousada-serra-da-india', 'hotel-rio-penedo', 'hotel-do-sino', 'hotel-titanic', 'pousada-aurora-mantiqueira', 'pousada-chez-nous', 'pousada-penedo', 'pousada-reserva-penedo', 'pousada-terraco', 'pousada-villa-luna', 'pousada-rainha-da-mata', 'vila-francesa-hotel', 'aglio-e-olio', 'bazzini-pizzeria', 'borbulha-penedo', 'botegare', 'braseiro-gaucho', 'casa-da-picanha', 'casa-do-fritz', 'enoteca-serrana', 'estancia-penedo', 'kaiten-sushi', 'loazo-resto', 'petit-gourmet', 'pizza-da-villa', 'querencia', 'rei-das-trutas', 'restaurante-finlandes', 'truta-viva', 'zero-a-zero', 'tonttulakki-suklaat', 'lugano-penedo', 'lolita-penedo', 'kahvila-cafe', 'chocolate-do-papai-noel', 'emporio-haru', 'emporio-chamoun', 'culto-cafe', 'rosana-balas-coco', 'from-penedo-delicatessen', 'cantinho-mineiro-tia-lili', 'esquina-da-serra', 'quatro-marias-boulangerie', 'grao-padaria-penedo', 'rei-da-vila', 'pousada-recanto-de-moria', 'unica-arte-para-voce', 'azia-sushi-lounge', 'bistro-du-cheff', 'sorvete-de-penedo', 'sorvete-finlandes', 'acailandia-penedo', 'pe-de-canela-buteco', 'andicaro-penedo-cafes-especiais', 'clube-finlandia', 'esquilo-passeios', 'gute-passeios', 'restaurante-toa-toa', 'janela-divino'].includes(item.id) 
