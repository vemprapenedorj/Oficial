        ...
        <div className="flex items-center gap-2 mb-1">
          <div className="w-6 h-6 rounded-full overflow-hidden shrink-0 bg-white border border-white/20 flex items-center justify-center">
            <img 
              ...
              width={24}
              height={24}
              className={`w-full h-full ${['sorvete-de-penedo', 'deck-pizzaria-e-choperia'].includes(item.id) ? 'object-contain object-top p-0.5' : 'object-cover'}`} 
              loading="lazy"
              decoding="async"
              referrerPolicy="no-referrer"
              onError={(e) => {
