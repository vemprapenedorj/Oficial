    ...
    <div>
      ...
      <header className="relative pt-40 pb-6 md:pb-12 md:pt-48 md:pb-16 bg-penedo-forest text-center text-white overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img
            src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&q=80&w=1280&h=720"
            srcSet="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&q=72&w=768&h=432 768w, https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&q=80&w=1280&h=720 1280w"
            sizes="100vw"
            className="w-full h-full object-cover"
            alt="Gastronomia em Penedo RJ onde comer trutas e fondues"
            fetchPriority="high"
            decoding="async"
        ...
        <div className="relative z-10 px-4 max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">Restaurantes em Penedo RJ: <span className="text-penedo-gold">Onde Comer</span></h1>
