              ...
              <Carousel 
                ...
                renderItem={(item) => (
                  <InfoCard 
                    item={item} 
                    onOpen={(item) => {
                      if (item.id === 'melhores-pizzarias-de-penedo' || item.id === 'roteiro-1-dia-em-penedo' || item.id === 'penedo-guia' || item.id === 'cachoeiras-penedo' || item.id === 'restaurantes' || item.id === 'melhores-hospedagens') {
